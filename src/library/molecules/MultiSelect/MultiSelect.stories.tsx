...
const meta: Meta<typeof MultiSelect> = {
  ...
  argTypes: {
    ...
    selectedValues: {
      control: "object",
      description:
        "An array of selected option values. Can be used for controlled behavior.",
    },
    disabled: {
      control: "boolean",
    ...
    primaryClassName: {
      control: "text",
      description: "Custom class name for styling the MultiSelect component.",
    },
  },
  args: {
    options: [
...
const MultiSelectTemplate = (args: MultiSelectProps) => {
  ...
  return (
    ...
    >
      <MultiSelect.Label>Team Member *</MultiSelect.Label>
      <MultiSelect.Initiator />
      <MultiSelect.OptionsWrapper>
        {args.options.map((option) => (
          <MultiSelect.Option key={option.value} {...option} />
        ))}
      </MultiSelect.OptionsWrapper>
    </MultiSelect>
  );
